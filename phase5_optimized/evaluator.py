...
from implementation.evaluate import evaluate_all_retrieval, evaluate_all_answers
...
def main():
    with gr.Blocks(title="RAG Evaluation Dashboard (Optimized)") as app:
        gr.Markdown("# RAG Evaluation Dashboard (Optimized)")
        gr.Markdown("Evaluate retrieval and answer quality for the Insurellm optimized RAG system")
        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                retrieval_chart = gr.BarPlot(
                    ...
                    title="Average MRR by Category", y_lim=[0, 1], height=400,
                )
        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                answer_chart = gr.BarPlot(
                    ...
                    title="Average Accuracy by Category", y_lim=[1, 5], height=400,
                )
    ...
    app.launch(inbrowser=True, theme=gr.themes.Soft(font=["Inter", "system-ui", "sans-serif"]))
